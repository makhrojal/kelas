...
export const mockPrograms: Program[] = [
  { id: 'karier-asn', nama: 'PROGRAM KARIER ASN', slug: 'karier-asn', deskripsi: 'Persiapan seleksi dan pengembangan karier ASN (SAKIP, SPIP, MR, UKI).', urutan: 1, createdAt: new Date().toISOString() },
  { id: 'ptn-utbk', nama: 'PROGRAM PTN-UTBK', slug: 'ptn-utbk', deskripsi: 'Persiapan intensif menghadapi UTBK SNBT (TPS & Literasi).', urutan: 2, createdAt: new Date().toISOString() },
  { id: 'skd', nama: 'PROGRAM SKD', slug: 'skd', deskripsi: 'Seleksi Kompetensi Dasar (TWK, TIU, TKP) untuk CPNS/Kedinasan.', urutan: 3, createdAt: new Date().toISOString() },
  { id: 'skb-stan', nama: 'PROGRAM SKB PKN STAN', slug: 'skb-stan', deskripsi: 'Seleksi Kompetensi Bidang khusus PKN STAN (TPA & TBI).', urutan: 4, createdAt: new Date().toISOString() },
  { id: 'toefl', nama: 'PROGRAM TOEFL', slug: 'toefl', deskripsi: 'Persiapan sertifikasi TOEFL (Listening, Structure, Reading).', urutan: 5, createdAt: new Date().toISOString() },
  { id: 'psikotes', nama: 'PROGRAM PSIKOTES', slug: 'psikotes', deskripsi: 'Latihan berbagai macam tes psikologi dan kepribadian.', urutan: 6, createdAt: new Date().toISOString() },
  { id: 'wawancara', nama: 'PROGRAM WAWANCARA', slug: 'wawancara', deskripsi: 'Teknik dan simulasi wawancara kerja atau beasiswa.', urutan: 7, createdAt: new Date().toISOString() },
  { id: 'kesehatan', nama: 'PROGRAM KESEHATAN (MCU)', slug: 'kesehatan', deskripsi: 'Panduan dan persiapan Medical Check-Up.', urutan: 8, createdAt: new Date().toISOString() },
  { id: 'kebugaran', nama: 'PROGRAM KEBUGARAN', slug: 'kebugaran', deskripsi: 'Latihan fisik (Kesamaptaan) untuk seleksi instansi.', urutan: 9, createdAt: new Date().toISOString() }
];
...
export const mockKelas: Kelas[] = [
  ...
  { id: 'goals', programId: 'wawancara', nama: 'Motivation & Goals', slug: 'goals', deskripsi: 'Menjelaskan motivasi dan tujuan masa depan.', urutan: 2, createdAt: new Date().toISOString() },
  { id: 'behavioral', programId: 'wawancara', nama: 'Behavioral Questions', slug: 'behavioral', deskripsi: 'Menjawab pertanyaan berbasis perilaku (STAR method).', urutan: 3, createdAt: new Date().toISOString() },
  { id: 'critical', programId: 'wawancara', nama: 'Critical & Analytical Questions', slug: 'critical', deskripsi: 'Menghadapi pertanyaan jebakan dan analisis.', urutan: 4, createdAt: new Date().toISOString() },
  { id: 'communication', programId: 'wawancara', nama: 'Communication & Body Language', slug: 'communication', deskripsi: 'Bahasa tubuh dan intonasi suara.', urutan: 5, createdAt: new Date().toISOString() },
  // KESEHATAN
